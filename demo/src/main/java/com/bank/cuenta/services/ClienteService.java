...
public class ClienteService {
    ...
    public ClienteService(ClienteRespository clienteRepository, PersonaService personaService, CuentaService cuentaService, MovimientoService movimientoService, RabbitTemplate rabbitTemplate) {
